...
string Validator::validateCommand() const {
    ...
    if(token.compare("create") == 0 || token.compare("exit") == 0 || token.compare("delete") == 0 || token.compare("update") == 0 || token.compare("show") == 0 || token.compare("optimize") == 0 || token.compare("search") == 0){
        return command;
    }
